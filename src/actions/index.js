...
export const addItem = (name) => (dispatch, ownProps) => {
  return dispatch(addItemAction(name))
}

export const initRouteAction = () => ({
  type: INIT_ROUTE
})

export const initCarouselAction = () => ({
  type: INIT_CAROUSEL
})

export const initCarousel = () => (dispatch, ownProps) => {
  return dispatch(initCarouselAction())
}

export const initRoute = () => (dispatch, ownProps) => {
